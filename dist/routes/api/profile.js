...
router.post('/', auth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, subject, bio, isAvailable, major, findUser, profile, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, subject = _a.subject, bio = _a.bio, isAvailable = _a.isAvailable, major = _a.major;
...
router.get('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, Profile.findOne({ user: req.params.id })];
            case 2:
                profile = _a.sent();
                res.json(profile);
                return [3 /*break*/, 4];
